...
if (baseCal <= 4664.68) {tabela = baseCal * 0.225;};
if (baseCal >= 4664.68) {tabela = baseCal * 0.275;};
System.out.println("O valor de acordo com a tabela é: " + tabela);
alíquota = 0;
if (tabela <= 2826.65) {alíquota = 0.075;);
if (tabela <= 3751.05) {alíquota = 0.15;);
if (tabela <= 4664.68) {alíquota = 0.225;);
if (tabela >= 4664.68) {alíquota = 0.275;);
